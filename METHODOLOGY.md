# Methodology: paper vs. replication

This document is the detailed companion to [`README.md`](README.md). It covers what the original paper did, exactly how each step was implemented here, which results reproduce the paper, and every point where this replication deviates from it — deliberately or not.

## Table of contents

1. [What the paper did](#what-the-paper-did)
2. [What was implemented](#what-was-implemented)
3. [Results that reproduce the paper](#results-that-reproduce-the-paper)
4. [Deliberate differences and their rationale](#deliberate-differences-and-their-rationale)
5. [Unintentional gaps and blockers](#unintentional-gaps-and-blockers)
...
Output: `results/tables/methylation_geo_validation.csv` (see [Caveats in the validation step](#unintentional-gaps-and-blockers)).
...
9. **Filename/docs inconsistencies.**
   `o7_wgcma_modules.R` is a typo for the WGCNA step; script headers reference missing `docs/0*.md` files (this file and `README.md`/`REPRODUCE.md` replace them).
